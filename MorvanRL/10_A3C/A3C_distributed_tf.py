...
"""
# https://github.com/MorvanZhou/Reinforcement-learning-with-tensorflow/blob/master/contents/10_A3C/A3C_distributed_tf.py
    ...
    def __init__(self, scope, opt_a=None, opt_c=None, global_net=None):
        if scope == 'global_net':  # get global network
            ...
            with tf.variable_scope(scope):
                ...
                self.v_targe =  tf.placeholder(tf.float32,[None,1],'Vtarget')

                self.a_prob, self.v, self.a_params, self.c_params = self._build_net(scope)

                td = tf.subtract(self.v_targe,self.v,name='TD_error')
                ...
                while True:
                    ...
                    if total_step %UPDATE_GLOBAL_ITER ==0:# update global and assign to local net
                        ...
                        feed_dict = {
                            ...
                            local_net.v_targe:buffer_v_target
                        }
